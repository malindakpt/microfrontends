...
/**
 * Checks if provided object has 0 properties.
 * Having a property with undefined values will result in `false`.
 */
 ...
 * Useful for parsing Error objects to remove prototype properties.
 */
