export const config = {
  ...
  vipJobUrl: process.env.VIP_JOB_URL,
  vipAuthHeader: process.env.VIP_AUTH_HEADER,
  vipServiceBusSenderConnection: process.env.VIP_SERVICE_BUS_SENDER_CONNECTION,
  vipServiceBusManagerConnection:
    process.env.VIP_SERVICE_BUS_MANAGER_CONNECTION,
